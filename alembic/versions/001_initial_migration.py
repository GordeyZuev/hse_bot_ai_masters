...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_deadlines_subject_id", "deadlines", ["subject_id"], unique=False
    )
    ...
    op.create_index(
        "idx_subscriptions_subject_id", "subscriptions", ["subject_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_notification_log_status_scheduled", table_name="notification_log"
    )
