...
def upgrade() -> None:
    ...
    op.drop_index('idx_notification_log_user_id', table_name='notification_log', if_exists=True)
    op.drop_index('idx_notification_log_status_scheduled', table_name='notification_log', if_exists=True)
